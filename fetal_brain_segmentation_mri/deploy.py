...
def predict(args):
    ...
    # From the model model_path, parse the latest saved estimator model and restore a predictor from it
    ...
    for output in read_fn(file_names, mode=tf.estimator.ModeKeys.EVAL, params=READER_PARAMS):
        ...
        # Print outputs 
        print('Dice={}; input_dim={}; time={}; output_fn={};'.format(dsc, img.shape, time.time()-t0, output_fn))
